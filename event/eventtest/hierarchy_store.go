...
// HierarchyStoreMock is a mock implementation of HierarchyStore.
//
//     func TestSomethingThatUsesHierarchyStore(t *testing.T) {
//
//         // make and configure a mocked HierarchyStore
...
// 	               panic("TODO: mock out the BuildHierarchy method")
//             },
//         }
//
//         // TODO: use mockedHierarchyStore in code that requires HierarchyStore
...
func (mock *HierarchyStoreMock) BuildHierarchy(instanceID string, codeListID string, dimensionName string) error {
	if mock.BuildHierarchyFunc == nil {
		panic("moq: HierarchyStoreMock.BuildHierarchyFunc is nil but HierarchyStore.BuildHierarchy was just called")
	}
	callInfo := struct {
		InstanceID    string
		CodeListID    string
