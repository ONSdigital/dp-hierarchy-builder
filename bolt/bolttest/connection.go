...
var (
	...
	lockConnMockGetTimeout      sync.RWMutex
...
func (mock *ConnMock) Begin() (driver.Tx, error) {
	if mock.BeginFunc == nil {
		panic("ConnMock.BeginFunc: method is nil but Conn.Begin was just called")
	}
	callInfo := struct {
	}{}
...
func (mock *ConnMock) ExecNeo(query string, params map[string]interface{}) (golangNeo4jBoltDriver.Result, error) {
	if mock.ExecNeoFunc == nil {
		panic("ConnMock.ExecNeoFunc: method is nil but Conn.ExecNeo was just called")
	}
	callInfo := struct {
		Query  string
		Params map[string]interface{}
...
func (mock *ConnMock) ExecPipeline(query []string, params ...map[string]interface{}) ([]golangNeo4jBoltDriver.Result, error) {
	if mock.ExecPipelineFunc == nil {
		panic("ConnMock.ExecPipelineFunc: method is nil but Conn.ExecPipeline was just called")
	}
	callInfo := struct {
		Query  []string
		Params []map[string]interface{}
...
func (mock *ConnMock) GetTimeout() time.Duration {
	if mock.GetTimeoutFunc == nil {
		panic("ConnMock.GetTimeoutFunc: method is nil but Conn.GetTimeout was just called")
	}
	callInfo := struct {
	}{}
	lockConnMockGetTimeout.Lock()
	mock.calls.GetTimeout = append(mock.calls.GetTimeout, callInfo)
	lockConnMockGetTimeout.Unlock()
	return mock.GetTimeoutFunc()
}

// GetTimeoutCalls gets all the calls that were made to GetTimeout.
// Check the length with:
//     len(mockedConn.GetTimeoutCalls())
func (mock *ConnMock) GetTimeoutCalls() []struct {
} {
	var calls []struct {
	}
	lockConnMockGetTimeout.RLock()
	calls = mock.calls.GetTimeout
	lockConnMockGetTimeout.RUnlock()
	return calls
}
...
func (mock *ConnMock) PrepareNeo(query string) (golangNeo4jBoltDriver.Stmt, error) {
	if mock.PrepareNeoFunc == nil {
		panic("ConnMock.PrepareNeoFunc: method is nil but Conn.PrepareNeo was just called")
	}
	callInfo := struct {
		Query string
	}{
...
func (mock *ConnMock) PreparePipeline(query ...string) (golangNeo4jBoltDriver.PipelineStmt, error) {
	if mock.PreparePipelineFunc == nil {
		panic("ConnMock.PreparePipelineFunc: method is nil but Conn.PreparePipeline was just called")
	}
	callInfo := struct {
		Query []string
	}{
...
func (mock *ConnMock) QueryNeo(query string, params map[string]interface{}) (golangNeo4jBoltDriver.Rows, error) {
	if mock.QueryNeoFunc == nil {
		panic("ConnMock.QueryNeoFunc: method is nil but Conn.QueryNeo was just called")
	}
	callInfo := struct {
		Query  string
		Params map[string]interface{}
...
func (mock *ConnMock) QueryNeoAll(query string, params map[string]interface{}) ([][]interface{}, map[string]interface{}, map[string]interface{}, error) {
	if mock.QueryNeoAllFunc == nil {
		panic("ConnMock.QueryNeoAllFunc: method is nil but Conn.QueryNeoAll was just called")
	}
	callInfo := struct {
		Query  string
		Params map[string]interface{}
...
func (mock *ConnMock) QueryPipeline(query []string, params ...map[string]interface{}) (golangNeo4jBoltDriver.PipelineRows, error) {
	if mock.QueryPipelineFunc == nil {
		panic("ConnMock.QueryPipelineFunc: method is nil but Conn.QueryPipeline was just called")
	}
	callInfo := struct {
		Query  []string
		Params []map[string]interface{}
...
func (mock *ConnMock) SetChunkSize(in1 uint16) {
	if mock.SetChunkSizeFunc == nil {
		panic("ConnMock.SetChunkSizeFunc: method is nil but Conn.SetChunkSize was just called")
	}
	callInfo := struct {
		In1 uint16
	}{
...
func (mock *ConnMock) SetTimeout(in1 time.Duration) {
	if mock.SetTimeoutFunc == nil {
		panic("ConnMock.SetTimeoutFunc: method is nil but Conn.SetTimeout was just called")
	}
	callInfo := struct {
		In1 time.Duration
	}{
