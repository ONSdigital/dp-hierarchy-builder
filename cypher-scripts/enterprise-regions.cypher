...
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000002",label:"Buckinghamshire Thames Valley" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000003",label:"Cheshire and Warrington" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000004",label:"Coast to Capital" });
...
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000008",label:"Derby, Derbyshire, Nottingham and Nottinghamshire" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000009",label:"Dorset" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000010",label:"Enterprise M3" });
...
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000017",label:"Hertfordshire" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000018",label:"Humber" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000019",label:"Lancashire" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000020",label:"Leeds City Region" });
...
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000023",label:"London" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000024",label:"New Anglia" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000025",label:"North East" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000027",label:"Oxfordshire" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000029",label:"Solent" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000030",label:"South East" });
...
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000039",label:"York, North Yorkshire and East Riding" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000040",label:"Sheffield City Region" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000041",label:"South East Midlands" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000042",label:"Greater Cambridge and Greater Peterborough" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000013",label:"Greater Cambridge and Greater Peterborough" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000026",label:"Northamptonshire" });
CREATE (node:`_generic_hierarchy_node_enterprise-regions` { code:"E37000031",label:"South East Midlands" });
...
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000002"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000003"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000004"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
...
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000008"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000009"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000010"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
...
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000017"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000018"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000019"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000020"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
...
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000023"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000024"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000025"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000027"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000029"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000030"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
...
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000039"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000040"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000041"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000042"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000013"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000026"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
WHERE parent.code = "E92000001" AND child.code = "E37000031"
CREATE (child)-[:hasParent]->(parent);
MATCH (parent:`_generic_hierarchy_node_enterprise-regions`),(child:`_generic_hierarchy_node_enterprise-regions`)
